...
export const recommendations = [
  { name: 'Pranav Kulshreshtha', title: 'Principal AI Engineering, Architecture | Gen AI | Building Scalable AI Agents | AI Strategy', context: 'Senior to Sohaib, did not manage him directly',
    quote: 'Sohaib is a strong Platform Engineer with excellent technical acumen and a practical approach to solving complex problems. He learns quickly, takes ownership, and has a solid understanding of cloud infrastructure, automation, CI/CD, and developer/AI platforms. What stands out is his curiosity, reliability, and ability to turn new concepts into practical solutions. Sohaib has a strong growth mindset and the technical foundation to make a meaningful impact in platform engineering. I\u2019ve really enjoyed seeing his progress and would be confident in his ability to thrive in a strong engineering environment.' },
